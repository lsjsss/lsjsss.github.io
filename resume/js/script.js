...
function showClosePicture2() {
  if(document.getElementById("Close2")) {
    ...
    para.appendChild(node);
    // 选出id=Study的标签
    var element = document.getElementById("CloseButton2");
    // 在该标签之后加上刚创建的input标签
    element.appendChild(para);
    // 将节点插到指定标签之前
...
function delClosePicture2() {
  // 删除存在的标签
  // 以下代码是已知要查找的子元素，然后查找其父元素，再删除这个子元素（删除节点必须知道父节点）：
  var parent = document.getElementById("CloseButton2");
...
function showClosePicture3() {
  if(document.getElementById("Close3")) {
    ...
    para.appendChild(node);
    // 选出id=Study的标签
    var element = document.getElementById("CloseButton3");
    // 在该标签之后加上刚创建的input标签
    element.appendChild(para);
    // 将节点插到指定标签之前
...
function delClosePicture3() {
  // 删除存在的标签
  // 以下代码是已知要查找的子元素，然后查找其父元素，再删除这个子元素（删除节点必须知道父节点）：
  var parent = document.getElementById("CloseButton3");
